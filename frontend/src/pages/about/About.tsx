        ...
        <div className="about flex flex-col gap-y-10 md:px-0 px-6">
                ...
                <section className="flex items-center gap-x-8 flex-col md:flex-row">
                    ...
                    <div className="information w-full">
                        ...
                        <div className="directinfo grid grid-cols-2 md:gap-x-6 gap-x-4 mt-5">
                            <div className="telephone border-[1px] border-third px-5 py-4 md:p-6 rounded-3xl flex flex-col md:flex-row gap-x-4">
                                <FaWhatsapp size={60}/>
                                <div className="tulisan mt-2 md:mt-0">
                                    <h1 className="text-[18px] md:text-[20px] font-bold mb-1">Hubungi Kami</h1>
                                    <p className="text-[14px] md:text-[15px] md:text-justify h-[90px] md:h-auto mb-6">Apabila memiliki pertanyakan seputar informasi produk, pemesanan, komplain dan sebagainya</p>
                                    <a href="https://wa.me/62081929290560" target="_blank" className="border-2 border-third text-third hover:bg-third hover:text-white px-8 py-[6px] rounded-3xl text-[12px] md:text-[14px] transition duration-300">Whatsapp</a>
                                </div>
                            </div>
                            ...
                            <div className="telephone border-2 border-third px-5 py-4 md:p-6 rounded-3xl flex flex-col md:flex-row gap-x-4">
                                ...
                                <div className="tulisan mt-2 md:mt-0">
                                    <h1 className="text-[18px] md:text-[20px] font-bold">Kunjungi Toko</h1>
                                    <p className="mb-3 text-[14px] md:text-[14px] h-[90px] md:h-auto">untuk melakukan cek fisik barang dan pembelian secara langsung</p>
