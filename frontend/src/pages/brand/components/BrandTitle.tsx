...
export default function BrandTitle({ brand }: any){
    ...
    return (
        <div className="brand">
            <div className="atas grid grid-cols-[2fr_3fr] items-center gap-x-6">
                ...
                <div className="tulisan">
                    ...
                    <p className="text-justify text-[14px] md:text-[24px] mt-2 md:mt-0 italic inline">{brand.description}
                    </p>
                </div>
            </div>
        </div>
