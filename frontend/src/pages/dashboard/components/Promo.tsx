    ...
    return (
        <div className="main md:grid grid-cols-[2.5fr_1.5fr] gap-x-10 mt-10 md:mt-28 items-center">
            ...
            <div className="text-promo flex flex-col h-full justify-center relative md:overflow-hidden">
                ...
                <p className="md:text-[20px] mt-[-14px] md:mt-[-20px] text-center md:text-left md:indent-8">Nantikan tiap promo menarik hanya di <a href="/" className="font-semibold underline italic">Bandar Musik Jakarta</a>.</p>
                <a href="/promo" className="md:text-[20px] px-4 md:px-6 py-1 md:py-2 border-2 border-third mt-4 md:w-[210px] md:ml-14 flex items-center gap-x-2 group hover:bg-third hover:text-primary hover:rounded-r-3xl transition-all self-center">
                    Lihat promo
