...
export default function NavSearch(){
    ...
    return (
        <div className="search w-full">
                ...
                <input type="text" name="search" placeholder="Cari Kebutuhanmu...." className="bg-white px-4 py-3 rounded-full w-full font-[16px] indent-10 border-2 border-primary placeholder:text-gray-500 focus:border-none" value={search} onChange={(e)=>{setSearch(e.target.value)}}/>
                <div className="relative">
