...
export default async function initToken(req, res){
    ...
    res.cookie('accessToken', accessToken, { httpOnly: true, secure: true, maxAge: 10000, sameSite: false })
    res.cookie('refreshToken', refreshToken, { httpOnly: true, secure: true, maxAge: 1000 * 3600, sameSite: false })
